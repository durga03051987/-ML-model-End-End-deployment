...
# Load the studentmark.pkl file from the drive load pickle file from jupyter notebook saved 

app = Flask(__name__)
model = joblib.load(r"C:\Users\LakshmiSrinivas\Desktop\Day wise Assignments  to do AI program\June month Assignments\25th june Students mark prediction\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_marks_predict.pkl")
df = pd.DataFrame()
